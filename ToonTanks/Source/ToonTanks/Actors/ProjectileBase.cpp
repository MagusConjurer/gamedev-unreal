...
{
	// Get a reference to the owning class
	AActor* MyOwner = GetOwner();
	// If there is not valid reference, return out of the function
	if (!MyOwner) {	return;	}

	// If the other actor exist and isn't itself or the owner, then apply damage
